...
Состояние: **кодовый gate подтверждён на `215fd16`; живой браузерный gate ещё не выполнен**.
...
Живой gate Stage 4: получить обычный ответ в браузере, поставить 👍 или 👎,
обновить страницу и убедиться, что выбранная оценка сохранилась и отображается
как текущая.
