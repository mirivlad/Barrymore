...
const (
	...
	// CanonFromSkill — Бэрримор посмотрел сам. Источник отделён от разговора
	// намеренно: сказанное со слов и увиденное своими средствами имеют разный
	// вес, и смешивать их значило бы скрывать разницу.
	CanonFromSkill = "умение"
)
